...
Its given a function to be typed annotated.
```bash
...
Augment a given code with the correct duck-typed annotations.
```bash
...
Use mypy to validate a given piece of code and apply any necessary changes.
